...
## 🏆 주요 성과
- 한이음 과기부 동상 | SK C&C 대표이사상 | KIST AI 연구 인턴
- 네모 감성 허밍블럭스 CES 2025 수상 | 창업경진대회 특별상 수상
- 카카오뱅크우수장학생 수상 | csos 학부 연구생(자율주행)

---

## 📁 Featured Projects

### 🎵 허밍블럭스 - AI 음악 코딩 교육 플랫폼
...
### 🤖 AI 연구
**기술**: Python, OpenCV, TensorFlow, Pytorch 
**성과**: 
**역할**: 
...
> **자세한 내용**: [web_BE Repository](https://github.com/davJ-star/web_BE)
...
### 🤖 AI/ML Development Hub
> **자세한 내용**: [AI Repository](https://github.com/davJ-star/AI)
...
### ⚛️ Frontend Development Hub
> **자세한 내용**: [web_FE Repository](https://github.com/davJ-star/web_FE)
...
### 실습 및 학습 프로젝트
1. [first-spring-starter](https://github.com/davJ-star/first-spring-starter) - Spring Boot 기초 학습
2. [로그인과 그 모든 것: FE](https://github.com/side-projectFOR/signup) - 인증 시스템 프론트엔드
3. [로그인과 그 모든 것: BE](https://github.com/side-projectFOR/account) - 인증 시스템 백엔드

### 개발 환경 및 도구
- **채팅 시스템**: 실시간 커뮤니케이션 구현
- **MySQL 성능 최적화**: [리뷰 문서](https://github.com/davJ-star/web_BE/blob/main/README.md#mysql)
...
AI, 백엔드, 프론트엔드 개발에 대한 토론과 협업을 환영합니다. 혁신적인 프로젝트에 관심이 있으시면 언제든 연락주세요.
...
```
MyProject (메인 포트폴리오)
├── 📁 Featured Projects (주요 프로젝트 하이라이트)
├── 📁 web_BE (백엔드 전문 저장소)
├── 📁 AI (AI/ML 전문 저장소) 
├── 📁 web_FE (프론트엔드 전문 저장소)
└── 📁 Other Projects (기타 학습 및 실험 프로젝트)
```

각 전문 저장소에서 해당 분야의 심화된 프로젝트와 학습 내용을 확인하실 수 있습니다.
